...
const styles = StyleSheet.create({
  ...
  modalContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'grey'  },
  modalView: { backgroundColor: 'white', padding: 10, borderRadius: 10, width: '80%',     marginHorizontal: 10,
  },
